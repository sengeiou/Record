...
class BloodSugarTestViewController: BaseViewController {
    ...
    var progressView: BloodSugarTestProgressView!
    ...
    override func initDisplayView() {
        ...
        messageTopLabel.snp.makeConstraints { (make) in
            ...
            make.top.equalToSuperview().offset(Constant.margin)
        }
        ...
        progressView  = BloodSugarTestProgressView.init(frame: CGRect.init(x: x, y: y, width: width, height: width))
        ...
        if AppDelegate.getDelegate().BloodStartTestTime == 0 {
            ...
            let model = BloodSugarTestDataHelp.getBloodGluresult()
