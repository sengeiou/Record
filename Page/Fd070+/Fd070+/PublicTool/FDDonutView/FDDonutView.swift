...
class FDDonutView: UIView {

    var fromColour = UIColor.white
    var toColour = UIColor.yellow
    var baseColour = UIColor.white
...
//        }
    ...
    func animateTo(percentage: CGFloat) {
        ...
        viewRotationAnimation.timingFunction = CAMediaTimingFunction.init(name: kCAMediaTimingFunctionLinear)
    ...
    /// Set percentage without animate
    ///
    /// - Parameter percentage: percentage
    func set(percentage: CGFloat) {

        //1. update from percentage
        fromPercentage = percentage;
...
extension FDDonutView {
    func startRotationAnimation() {
        ...
        layer.add(baseAnimation, forKey: "contentLayer.baseAnimation")

    }
    func endRotationAnimation() {

        layer.removeAnimation(forKey: "contentLayer.baseAnimation")
    }
}
extension FDDonutView {
